...
routes=("198.18.0.0/30" "198.19.0.0/30")
...
sudo ip netns exec pause ip addr add 172.17.0.5/16 dev eth0
sudo ip netns exec pause ip addr add 172.17.0.6/16 dev eth0